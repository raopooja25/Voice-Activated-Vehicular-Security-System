...
def record_audio():
	if request.method == 'POST':
		...
		#SAVES AUDIO
		with open("nn_audio/chk/speaker/audio.wav", "wb") as f:
			f.write(audio_f.get_wav_data())
		#SPECTROGRAM
		y, sr = librosa.load('nn_audio/chk/speaker/audio.wav')
		...
		plt.savefig('nn_audio/chk/speaker/wav.jpg')
		plt.close()
...
def transcript():
	r = speech_recognition.Recognizer()
	audio_temp = speech_recognition.AudioFile('nn_audio/chk/speaker/audio.wav')
...
def lr_prediction():		
	...
	clip_path = 'C:/Users/Owner/Alexa_Project_IEOR290/deployment/final/nn_audio/chk/speaker'
	filename = 'audio.wav'
...
def cnn_prediction():
# define dir paths
	trn_dir = 'nn_audio/trn/'
	val_dir = 'nn_audio/val/'
	tst_dir = 'nn_audio/tst/'
